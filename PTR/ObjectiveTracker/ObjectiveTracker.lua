...
function ObjectiveTracker:OnDocumentReady()
	...
	self.wndObjectiveTrackerScroll:SetBGOpacity(self.nOpacity, knOpacityTime)
	...
	self.wndButtonArt:SetBGOpacity(self.nOpacity, knOpacityTime)
...
function ObjectiveTracker:OnBackgroundMouse(wndHandler, wndControl)
	...
	self.wndObjectiveTrackerScroll:SetBGOpacity(bHasMouse and self.nOpacityMouseOver or self.nOpacity, knOpacityTime)
	self.wndButtonArt:SetBGOpacity(bHasMouse and self.nOpacityMouseOver or self.nOpacity, knOpacityTime)
