...
function TradeskillContainer:OnLocateAchievement(idSchematic, achData)
	...
	if tSchematicInfo and tSchematicInfo.nParentSchematicId and tSchematicInfo.nParentSchematicId ~= 0 then -- Replace sub variants with their parent, we will open to their parent's page
